...
def test_document_lineage_supersession():
    ...
    candidates = [
        {
            "passage_id": "old_p1",
            "document_id": "doc_hdfc_midcap_2026_07",
            "scheme_ids": ["hdfc_mid_cap"],
        },
        {
            "passage_id": "new_p1",
            "document_id": "doc_hdfc_midcap_2026_08",
            "scheme_ids": ["hdfc_mid_cap"],
        },
    ]
    ...
    conflicting_passages = [
        {
            ...
            "source_url": "https://groww.in/p1",
        },
        {
            "passage_id": "p2",
            "normalized_text": "Exit load 2%",
            "source_url": "https://groww.in/p2",
        },
    ]
