...
def test_phase3b_smoke_queries_factual_and_refusal():
    ...
    r1 = client.post("/v1/questions", json={
    ...
    r2 = client.post("/v1/questions", json={
    ...
    r3 = client.post("/v1/questions", json={
        "query": "Which is the best fund to buy?",
...
def test_phase3b_rollout_stage_gating_and_allowlist():
    ...
    r_blocked = client.post(
        "/v1/questions",
        json={"query": "What is the expense ratio for HDFC Mid-Cap?", "conversation_id": "r-1"},
    ...
    r_allowed = client.post(
        "/v1/questions",
        json={"query": "What is the expense ratio for HDFC Mid-Cap Opportunities Fund?", "conversation_id": "r-2"},
...
def test_phase3b_emergency_automated_rollback():
    ...
    r_emergency = client.post(
        "/v1/questions",
        json={"query": "What is the expense ratio for HDFC Mid-Cap?", "conversation_id": "r-3"}
    )
    ...
    r_restored = client.post(
        "/v1/questions",
        json={"query": "What is the minimum SIP amount for HDFC Mid-Cap Opportunities Fund?", "conversation_id": "r-4"}
    )
