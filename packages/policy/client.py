...
class PolicyServiceClient:
    ...
    async def _safe_post(self, endpoint: str, payload: dict) -> Dict[str, Any]:
        try:
            ...
            return {
                ...
                "answer_sentences": ["The policy verification service is currently unavailable. Please try again later."],
                "citation_url": None
            }
    ...
    async def render_refusal(self, query_class: str, reason_code: Optional[str] = None, query: Optional[str] = None) -> Dict[str, Any]:
        payload = {
