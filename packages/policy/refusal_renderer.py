...
class RefusalRenderer:
    ...
    def render_refusal(self, query_class: str, reason_code: str = None, query: str = None) -> Dict[str, Any]:
        ...
        if is_hindi:
            answer_sentences = ["मैं इस प्रश्न का उत्तर देने में असमर्थ हूँ क्योंकि यह मेरे तथ्यों-के-दायरे से बाहर है।"]
        else:
            answer_sentences = ["I am unable to answer this question as it falls outside my facts-only scope."]
        return {
            "status": "POLICY_REFUSAL",
            "answer_sentences": answer_sentences,
            "citation_url": None,
