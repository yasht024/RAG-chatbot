...
history = [
    ...
    Message(role="assistant", content="To download your account statement, log in to the HDFC Mutual Fund investor portal or request it via SMS. (As of 2026-08-23)")
]
