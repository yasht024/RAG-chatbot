aliases = {
    ...
    "hdfc_multi_cap": ["HDFC Multi Cap", "HDFC Multicap", "HDFC Multi Cap Fund"],
    "hdfc_focused": ["HDFC Focused", "HDFC Focused 30", "HDFC Focused Fund"],
    "hdfc_value": ["HDFC Value", "HDFC Capital Builder", "HDFC Value Fund"],
    "hdfc_elss_tax_saver": [
        "HDFC ELSS",
        "HDFC Tax Saver",
        "HDFC ELSS Tax Saver",
    ...
    "hdfc_mnc": ["HDFC MNC", "HDFC MNC Fund"],
    "hdfc_business_cycle": ["HDFC Business Cycle", "HDFC Business Cycle Fund"],
    "hdfc_defence": ["HDFC Defence", "HDFC Defense", "HDFC Defence Fund"],
    "hdfc_consumption": ["HDFC Consumption", "HDFC Consumption Fund"],
    "hdfc_transportation_and_logistics": [
        "HDFC Transportation",
        "HDFC Logistics",
        "HDFC Transportation and Logistics Fund",
    ],
    "hdfc_technology": ["HDFC Tech", "HDFC Technology", "HDFC Technology Fund"],
    "hdfc_pharma_and_healthcare": [
        "HDFC Pharma",
        "HDFC Healthcare",
        "HDFC Pharma and Healthcare Fund",
    ],
    "hdfc_manufacturing": ["HDFC Manufacturing", "HDFC Manufacturing Fund"],
    "hdfc_infrastructure": [
        "HDFC Infra",
        "HDFC Infrastructure",
        "HDFC Infrastructure Fund",
    ],
    "hdfc_innovation": ["HDFC Innovation", "HDFC Innovation Fund"],
    "hdfc_childrens": [
        "HDFC Childrens",
    ...
    "hdfc_nifty_next_50_index": ["HDFC NIFTY Next 50", "HDFC Nifty Next 50 Index Fund"],
    "hdfc_nifty_100_index": ["HDFC NIFTY 100", "HDFC Nifty 100 Index Fund"],
    ...
    "sbi_small_cap": ["SBI Small Cap", "SBI Small Cap Fund"],
    "sbi_equity_hybrid": [
        "SBI Hybrid",
        "SBI Equity Hybrid",
    ...
    "sbi_bluechip": ["SBI Bluechip", "SBI Bluechip Fund"],
}
