...
class Orchestrator:
    ...
    def process_query(self, request: QueryRequest) -> FactualResponse:
        ...
        for fact_type in requested_facts:
            ...
            for target_scheme_id in target_schemes:
                # Keyword Search
                # Keyword Search
                try:
                ...
                expected_scheme = None if (amc_level and fact_type in amc_procedures) else target_scheme_id
                ...
                if decision.status == "VALID":
                    ...
                    evidence = EvidenceItem(
                        scheme_id=target_scheme_id or "AMC",
